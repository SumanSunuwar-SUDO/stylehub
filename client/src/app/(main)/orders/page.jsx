...
const OrdersHistoryPage = () => {
  ...
  const canCancelOrder = (order) => {
    ...
    // Optional: allow only within 24 hours
  ...
  if (orders.length === 0)
    return (
      <div className="bg-white rounded-lg shadow-md p-16 text-center max-w-[1400px] mx-auto">
  ...
  return (
    <main className="max-w-[1200px] mx-auto px-16 py-10 space-y-6">
      ...
      {orders.map((order) => (
        ...
        >
          {/* Order Header */}
          <div className="bg-gray-50 p-6 border-b flex flex-wrap justify-between items-start gap-4">
            <div>
